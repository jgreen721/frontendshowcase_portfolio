import { faqCard,nftCard,perfumeAd,resultsCard,makerPrelaunch,notificationsRedo,spaceApp, dictionary,multistepForm,notifications,pwordGenerator,rpsSite,bodyMass,clockSite,portfolio,quiz,taskManager,movieSite,speakerSite, rateUsCard, ccInput } from './const'
...
export const data = [
    {
      ...
      samples:[
        ...
        {id:5,translateId:4,title:"Service-rating Modal",description:"Enhance your site's user experience with this animated, responive Rate-Us Modal. Ensure valuable feedback in style.",technology:["HTML","CSS","JS"],img:rateUsCard,site:"https://jgreen721.github.io/frontend_challenges/ratingcard_figmaanimate_fec/",translate:315,borderRadius:"84% 16% 61% 39% / 8% 86% 14% 92%"},
    ...
    },
    {
      ...
      samples:[
        {id:1,translateId:0,title:"Maker Prelaunch",description:"Sleek and responsive sectional scrolling landing page using vanilla JavaScript, CSS, and the Intersection Observer API, optimizing UX with animating sections as they come into the users viewport.",technology:["HTML","CSS","JS"],img:makerPrelaunch,site:"https://jgreen721.github.io/frontend_challenges/maker-prelaunch/",translate:-105},
    ...
    },
    {
      ...
      samples:[
        ...
        {id:2,translateId:1,title:"Clock UI",description:"Dynamic Clock Application: Expertly crafted clock interface with seamless light/dark mode transitions. Integrated with a Quotes API, allowing users to click for instant inspiration, making time-checks a motivational experience.",technology:["HTML","CSS","JS"],img:clockSite,site:"https://clockapp-react.vercel.app/",translate:0},
        {id:3,translateId:2,title:"Portfolio Demo",description:"Elevate your professional image with a meticulously designed portfolio that captivates prospective clients. This sleek and modern layout showcases your work in a visually compelling manner, leaving a lasting impression that speaks volumes about your skills and expertise.",technology:["HTML","CSS","JS"],img:portfolio,site:"https://portfolio-challenge-three.vercel.app/",translate:105},
        {id:4,translateId:3,title:"Programming Quiz",description:"Seamlessly blending React logic with aesthetically pleasing design, my quiz application offers three engaging quizzes in HTML, CSS, and JS. Elevate user experience with dynamic question handling and real-time feedback, showcasing my proficiency in creating captivating and educational web applications.",technology:["React","CSS"],img:quiz,site:"https://fe-quiz.vercel.app/",translate:210},
        {id:5,translateId:4,title:"Dictionary UI",description:"This dictionary application, crafted with vanilla JS seamlessly integrates with a powerful api, immersing the user in a rich linguistic experience with authentic dictionary styling, complete with enunciations. User customization is at its core, featuring font and theme-mode toggles for a personalized and comfortable exploration of language.",technology:["HTML","CSS","JS"],img:dictionary,site:"https://jgreen721.github.io/frontend_challenges/dictionaryapp",translate:315},
        {id:6,translateId:5,title:"Planets-Info App",description:"A Vue.js planets-info app that seamlessly employs Vue's store for streamlined data distribution, effecting the UI for an enhanced and pleasing UX.",technology:["Vue"],img:spaceApp,site:"https://planetsapp-vue.vercel.app/",translate:420,borderRadius:"54% 36% 21% 59% / 82% 91% 34% 62%"},
    ...
    },
    {
      ...
      samples:[
        {id:1,translateId:0,title:"Movie Site",description:"A captivating React-powered movie site designed for frontend brilliance. Featuring a seamlessly navigable dashboard reminiscent of Netflix, complete with dynamic category filtering and local storage capabilities for user-generated favorites. This project serves as a frontend demonstration, offering a visually stunning showcase with login bypass convenience, although security measures are simulated for frontend purposes.",technology:["HTML","CSS","React"],img:movieSite,site:"https://fe-entertainmentwebapp.vercel.app/",translate:-105},
        {id:2,translateId:1,title:"Task Manager",description:"Engineered with React, this task management site redefines organization and collaboration. Users can seamlessly add, comment, and track tasks through various stages, each with its distinct status. Elevating user engagement, a 'likes' system encourages positive interaction, making this React-based project a comprehensive and user-friendly solution for effective task management.",technology:["HTML","Tailwind","React"],img:taskManager,site:"https://react-feedbackmanager.vercel.app/add",translate:0},
        {id:3,translateId:2,title:"SpeakerSite",description:"this dynamic speaker/audio retail site delivers a visually captivating frontend experience. Users can seamlessly navigate through multiple views, explore a rich catalogue with category filters, access detailed product information, and manage their selections with a user-friendly cart. While the checkout system is simulated for frontend purposes, this project showcases a visually striking and functionally robust audio retail platform.",technology:["HTML","CSS","JS"],img:perfumeAd,site:"https://perfume3d.vercel.app/",translate:105},
