...
const AboutMe = () => {
  return (
    ...
    <h5 className="thin indent my-1">Thanks to <span className="bold"><a className="about-me-link" target="_blank" href="https://frontendmentor.io">FrontEndMentor</a></span> I've accumalated several samples varying from single component snippets up to full-scale sites. Please look around and enjoy!</h5>
  </div>
  )
}
