...
const AboutMe = () => {
  return (
    ...
    <h5 className="thin indent my-1">Thanks to <span className="bold"><a className="about-me-link" target="_blank" href="https://frontendmentor.io">FrontEndMentor</a></span> I've <code>++</code>'ed my <code>SAMPLE_COUNT</code>, varying from single component snippets up to full-scale sites I welcome you to check out.</h5>
  </div>
  )
}
